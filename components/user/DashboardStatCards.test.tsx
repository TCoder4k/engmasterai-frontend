...
const analytics = (overrides: Partial<DashboardAnalytics> = {}): DashboardAnalytics => ({
  ...
  activity: {
    windowDays: 7,
    days: [
      { date: '2026-08-06', active: true, isFuture: false },
      { date: '2026-08-07', active: false, isFuture: false },
      { date: '2026-08-08', active: true, isFuture: false },
      { date: '2026-08-09', active: true, isFuture: false },
      { date: '2026-08-10', active: false, isFuture: false },
      { date: '2026-08-11', active: true, isFuture: false },
      { date: '2026-08-12', active: true, isFuture: false },
    ],
    currentStreakDays: 2,
    streakCapped: false,
  },
