...
const en = {
  ...
  header: {
    ...
    // Streak Together made this real — no longer "coming soon".
  ...
  // "Từ vựng của tôi" — a student's own saved-word list, reviewed through
  // its own queue (see vocab-personal backend module). Deliberately its own
  // namespace, not folded into `vocab` above: that namespace is entirely
  // about the admin-curated Library/Deck shelf, and this feature shares
  // none of its data or endpoints.
  myVocab: {
    ...
    tabDictation: "Writing",
    searchPlaceholder: "Search your words...",
    filterAll: "All",
    filterNew: "Not learned yet",
    ...
    emptyList: "You haven't saved any words yet.",
    emptyListCta: "Add your first word to start building your own review list.",
    noResultsFound: "No words match your search.",
    ...
    statsChartTitle: "Review activity",
    ...
    ipaLabel: "IPA",
    meaningViLabel: "Meaning (Vietnamese)",
    ...
    importSubmitting: "Saving...",
    importResultCreated: "words added",
    importResultSkipped: "already in your list",
    importEmpty: "Paste at least one word to import.",
    reviewSessionEmpty: "No words to review right now.",
    reviewSessionComplete: "Review complete!",
    backToList: "Back to My Vocabulary",
  },
  profile: {
  ...
  assistant: {
    ...
    engyTabLabel: "Engy AI",
    communityTabLabel: "Community",
    chatToolTabListLabel: "Chat tools",
  },
  chat: {
    title: "Engy",
  ...
  communityChat: {
    ...
    subtitle: "Chat, learn, and connect with everyone",
    filterAll: "All",
    refresh: "Refresh",
    composerLabel: "Message the community",
    ...
    failedGeneric: "Couldn't send this message. Please try again.",
    rateLimited: "You're sending messages too quickly. Try again in a moment.",
    loadError: "Couldn't load community messages.",
    loadingOlder: "Loading older messages…",
    emptyMessage: "No messages yet. Be the first to start the conversation!",
  ...
  streak: {
    ...
    backToList: "Back to Streaks",
    dayCount: (days: number) => `${days} day${days === 1 ? "" : "s"}`,
    withPartner: (name: string) => `You ❤️ ${name}`,
    studiedToday: "Studied today ✓",
    notStudiedToday: "Hasn't studied yet ⚠",
    ...
    shareError: "Couldn't generate a share link.",
    ...
    myStreaksSubtitle: "Build a daily study habit with friends!",
    ...
    inviteLinkRegister: "Sign up",
    inviteLinkJoin: "Join streak",
    inviteLinkJoining: "Joining…",
    inviteLinkOwnLink: "This is your own invite link — send it to a friend!",
    inviteLinkJoinError: "Couldn't join this streak. Please try again.",
  },
  notifications: {
    title: "Notifications",
...
const vi: TranslationDict = {
  ...
  checkout: {
    ...
    benefits: [
      "Lưu từ vựng không giới hạn (gói Free tối đa 50 từ)",
      "300 lượt tra cứu AI & trợ lý Engy / tháng",
      "30 lượt AI chấm phát âm chuyên sâu / tháng",
      "30 lượt luyện nói giao tiếp cùng AI / ngày",
      "Mở khóa toàn bộ kho luyện tập & bài học nâng cao",
    ],
  ...
  myVocab: {
    ...
    tabDictation: "Viết",
    searchPlaceholder: "Tìm kiếm từ của bạn...",
    filterAll: "Tất cả",
    filterNew: "Chưa thuộc",
    filterLearning: "Đang học",
    filterMastered: "Đã thuộc",
    sortNewest: "Mới nhất",
    sortOldest: "Cũ nhất",
    sortAlphabetical: "A đến Z",
    columnWord: "Từ vựng",
    columnMeaning: "Nghĩa",
    columnTags: "Nhãn",
    ...
    wordLabel: "Từ vựng",
    wordPlaceholder: "ví dụ: abandon",
    ipaLabel: "Phiên âm",
    meaningViLabel: "Nghĩa (Tiếng Việt)",
    meaningEnLabel: "Nghĩa (Tiếng Anh)",
    exampleSentenceLabel: "Câu ví dụ",
    exampleTranslationLabel: "Dịch câu ví dụ",
    tagsLabel: "Nhãn",
    tagsPlaceholder: "ví dụ: TOEIC, CET 6 (phân cách bằng dấu phẩy)",
    lookingUp: "Đang tra cứu...",
    lookupFailed: "Không tự động tra được từ này — bạn vẫn có thể tự điền.",
    save: "Lưu",
    saving: "Đang lưu...",
    ...
    importSubmitting: "Đang lưu...",
    importResultCreated: "từ đã thêm",
    importResultSkipped: "đã có trong danh sách",
    importEmpty: "Dán ít nhất một từ để nhập.",
    reviewSessionEmpty: "Không có từ nào cần ôn tập lúc này.",
    reviewSessionComplete: "Đã ôn tập xong!",
    backToList: "Quay lại Từ vựng của tôi",
  },
  profile: {
  ...
  assistant: {
    ...
    engyTabLabel: "Engy AI",
    communityTabLabel: "Tán gẫu",
    chatToolTabListLabel: "Công cụ trò chuyện",
  },
  chat: {
    title: "Engy",
  ...
  communityChat: {
    ...
    subtitle: "Trò chuyện, học hỏi và kết nối cùng mọi người",
    filterAll: "Tất cả",
    refresh: "Làm mới",
    composerLabel: "Nhắn tin trong Tán gẫu cộng đồng",
  ...
  streak: {
    ...
    actionFailed: "Đã có lỗi xảy ra. Vui lòng thử lại.",
    backToList: "Về danh sách chuỗi",
    dayCount: (days: number) => `${days} ngày`,
    withPartner: (name: string) => `Bạn ❤️ ${name}`,
    studiedToday: "Đã học hôm nay ✓",
    notStudiedToday: "Chưa học hôm nay ⚠",
    ...
    longestStreak: "Ngày dài nhất",
    rank: "Xếp hạng của bạn",
    topPercent: (percent: number) => `Top ${percent}%`,
    share: "Chia sẻ chuỗi",
    shareTitle: "Chia sẻ chuỗi của bạn",
    shareError: "Không thể tạo liên kết chia sẻ.",
    shareCaption: (name: string, days: number) =>
    ...
    myStreaksSubtitle: "Cùng bạn bè xây dựng thói quen học tập mỗi ngày!",
