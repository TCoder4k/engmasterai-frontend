...
const en = {
  ...
  streak: {
    ...
    shareVia: "Share via",
    joinLinkCardTitle: "Join a friend's streak",
    joinLinkCardDescription: "If you received an invite link from a friend, click it to join their streak.",
    joinLinkCardPlaceholder: "When you click an invite link, a \"Join streak\" button will appear here.",
...
const vi: TranslationDict = {
  ...
  streak: {
    ...
    joinLinkCardTitle: "Tham gia chuỗi cùng bạn bè",
    joinLinkCardDescription: "Nếu bạn nhận được link mời từ bạn bè, hãy nhấn vào link để tham gia chuỗi.",
    joinLinkCardPlaceholder: "Khi nhấn vào link mời, nút \"Tham gia chuỗi\" sẽ xuất hiện ở đây.",
