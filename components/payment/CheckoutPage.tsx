...
import { Copy, Check, Zap, Clock, AlertCircle, CheckCircle2, Info, Crown, Landmark, CreditCard, User, MessageSquare } from 'lucide-react';
    ...
    <StudentLayout>
      <div className="mx-auto flex max-w-[1180px] flex-col gap-4">
        ...
        <p className="-mt-2 text-sm text-slate-500 dark:text-slate-400">
          {user?.isPro && user.proExpiresAt ? t.checkout.renewalNotice(formatDate(user.proExpiresAt)) : t.checkout.subtitle}
        </p>
        ...
        <div className="grid items-start gap-4 xl:grid-cols-[minmax(0,1.7fr)_minmax(280px,360px)]">
            <div className="flex flex-col gap-4">
              <section className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
                <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-100 px-4 py-3 sm:px-5 dark:border-slate-800">
                  <div>
