...
// Engy Chat MVP (Phase B/C) — extracted out of ChatPanel.tsx (Community Chat
// sprint) so ChatPanel could become a thin tab shell hosting this view AND
// CommunityChatPanel side by side. Everything below is unchanged behaviour,
// just no longer also owning the dialog chrome (panelRef/focus-trap/outside-
// click/Escape/close button all now live in ChatPanel.tsx, shared across
// both tabs). Only ONE message may be in flight/failed at a time
// (composerDisabled below): this keeps "sending / success / failed"
