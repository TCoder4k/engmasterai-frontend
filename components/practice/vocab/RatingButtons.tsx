...
const RATING_STYLES: Record<ReviewRating, string> = {
  ...
  EASY: 'bg-indigo-50 dark:bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-100 dark:hover:bg-indigo-500/20 focus-visible:ring-indigo-400',
};
